...
export default function DashboardClient() {
  ...
  return (
    <div>
      <div className="m-10">
        <h1 className="text-2xl font-medium">Dashboard Retenção</h1>
        <p className="text-pink-400 text-lg">Visão geral de atendimentos</p>
      </div>

      <div className="flex items-center justify-center gap-5 flex-wrap">
        <CardChart Icon={Headphones} colorIcon={"#06fefa"} title={"Atendimentos em andamento"} value={data?.[5]?.Retencao ?? "Carregando..."} />
